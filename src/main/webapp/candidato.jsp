...
<jsp:include page="/WEB-INF/paginas/componentes/botonAgregar.jsp">  
 <jsp:param name="btnTitulo" value="Agregar Candidato"/>
  <jsp:param name="idName" value="Candidato"/>     
 </jsp:include>
	
	<!-- Mostrar Candidatos -->
	<jsp:include page="/WEB-INF/paginas/candidato/mostrarCandidatos.jsp"/> 
		<!-- Agregar Candidatos -->
	<jsp:include page="/WEB-INF/paginas/candidato/agregarCandidato.jsp"/> 
